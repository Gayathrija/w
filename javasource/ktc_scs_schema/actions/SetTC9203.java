...
public class SetTC9203 extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __mxObject;
	private ktc_scs_schema.proxies.TC9203_INPART03DS mxObject;

	public SetTC9203(IContext context, IMendixObject mxObject)
	{
		super(context);
	...
	{
		this.mxObject = __mxObject == null ? null : ktc_scs_schema.proxies.TC9203_INPART03DS.initialize(getContext(), __mxObject);
