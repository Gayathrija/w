...
import ktc_scs_schema.proxies.TC3610_KNTRLL10DS_Rs;
import ktcmdwscsconnector.customs.MessageClass;

public class GetTC3610 extends CustomJavaAction<IMendixObject>
{
	private java.lang.String messageString;

	public GetTC3610(IContext context, java.lang.String messageString)
	{
		super(context);
	...
	public IMendixObject executeAction() throws Exception
	{
		...
		TC3610_KNTRLL10DS_Rs msg = new TC3610_KNTRLL10DS_Rs(this.getContext());
		...
		try
		{
			...
			msg.setKTCVV2(msgClass.getMessageNumber(3, true));
