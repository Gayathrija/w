...
import ktc_scs_schema.proxies.TC5025_KNTRLL02DS;
import ktcmdwscsconnector.customs.MessageClass;

public class GetTC5025 extends CustomJavaAction<java.util.List<IMendixObject>>
{
	private java.lang.String messageString;
	private java.lang.String searchKey;
	private java.lang.String moreRecord;

	public GetTC5025(IContext context, java.lang.String messageString, java.lang.String searchKey, java.lang.String moreRecord)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		try
		{
			...
			{
				TC5025_KNTRLL02DS msg = new TC5025_KNTRLL02DS(this.getContext());
				...
				msg.setKNASTS(msgClass.getMessageNumber(3, 0));
