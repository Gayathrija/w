...
public class SetTC5036 extends CustomJavaAction<java.lang.String>
{
	private java.lang.String cardNumber;

	public SetTC5036(IContext context, java.lang.String cardNumber)
	{
		super(context);
	...
	public java.lang.String executeAction() throws Exception
	{
		...
		try
		{
			...
			sb.append(MessageClass.setMessageNumber(this.cardNumber,  19));	//Card number    
			...
			sb.append(MessageClass.setMessageNumber("0", 7));
			sb.append(MessageClass.setMessageNumber("0", 3));
			sb.append(MessageClass.setMessageString("0", 25));
			sb.append(MessageClass.setMessageString("0", 1));
