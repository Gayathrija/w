...
public class SetTC9414 extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __mxObject;
	private ktc_scs_schema.proxies.TC9414_KORTRG03DS mxObject;

	public SetTC9414(IContext context, IMendixObject mxObject)
	{
		super(context);
	...
	{
		this.mxObject = __mxObject == null ? null : ktc_scs_schema.proxies.TC9414_KORTRG03DS.initialize(getContext(), __mxObject);
