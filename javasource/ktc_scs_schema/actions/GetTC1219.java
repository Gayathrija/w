...
import ktc_scs_schema.proxies.TC1219_KNTRSK07DS;
import ktcmdwscsconnector.customs.MessageClass;

public class GetTC1219 extends CustomJavaAction<java.util.List<IMendixObject>>
{
	private java.lang.String messageString;
	private java.lang.String searchKey;
	private java.lang.String moreRecord;

	public GetTC1219(IContext context, java.lang.String messageString, java.lang.String searchKey, java.lang.String moreRecord)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		try
		{
			...
			{
				TC1219_KNTRSK07DS msg = new TC1219_KNTRSK07DS(this.getContext());
				...
				msg.setWDAVAL(msgClass.getMessageNumber(15, 2));
