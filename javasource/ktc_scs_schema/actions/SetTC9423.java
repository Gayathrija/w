...
public class SetTC9423 extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __mxObject;
	private ktc_scs_schema.proxies.TC9423_KORTRG05DS mxObject;

	public SetTC9423(IContext context, IMendixObject mxObject)
	{
		super(context);
	...
	{
		this.mxObject = __mxObject == null ? null : ktc_scs_schema.proxies.TC9423_KORTRG05DS.initialize(getContext(), __mxObject);
