...
import ktc_scs_schema.proxies.TC5011_CUSMSCDS;
import ktcmdwscsconnector.customs.MessageClass;

public class GetTC5011 extends CustomJavaAction<java.util.List<IMendixObject>>
{
	private java.lang.String messageString;
	private java.lang.String searchKey;
	private java.lang.String moreRecord;

	public GetTC5011(IContext context, java.lang.String messageString, java.lang.String searchKey, java.lang.String moreRecord)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		try
		{
			...
			{
				TC5011_CUSMSCDS msg = new TC5011_CUSMSCDS(this.getContext());
				...
				msg.setMSDTTM(msgClass.getMessageNumber(14, 0));
