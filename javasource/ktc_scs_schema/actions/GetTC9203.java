...
import ktc_scs_schema.proxies.TC9203_INPART03DS;
import ktcmdwscsconnector.customs.MessageClass;

public class GetTC9203 extends CustomJavaAction<IMendixObject>
{
	private java.lang.String messageString;

	public GetTC9203(IContext context, java.lang.String messageString)
	{
		super(context);
	...
	public IMendixObject executeAction() throws Exception
	{
		...
		TC9203_INPART03DS msg = new TC9203_INPART03DS(this.getContext());
		...
		try
		{
			...
			msg.setIPMBRS(msgClass.getMessageNumber(6, false));
			msg.setIPSEX(msgClass.getMessageNumber(1, false));
			...
			msg.setIPITYP(msgClass.getMessageNumber(1, false));
			...
			msg.setIPFLDT(msgClass.getMessageNumber(6, false));
			...
			msg.setIPCODT(msgClass.getMessageNumber(8, false));
			...
			msg.setIPDTTM(msgClass.getMessageNumber(14, false));
			msg.setIPTEL3(msgClass.getMessageString(20));
			msg.setIPLBIL(msgClass.getMessageString(1));
			msg.setIPEXDT(msgClass.getMessageNumber(8, false));
			msg.setIPBVDT(msgClass.getMessageNumber(8, false));
			...
			msg.setIPSPED(msgClass.getMessageNumber(8, false));
			msg.setIPSPCD(msgClass.getMessageNumber(8, false));
