...
import ktc_scs_schema.proxies.TC5047_ACCSTR01DS;
import ktcmdwscsconnector.customs.MessageClass;

public class GetTC5047 extends CustomJavaAction<java.util.List<IMendixObject>>
{
	private java.lang.String messageString;
	private java.lang.String searchKey;
	private java.lang.String moreRecord;

	public GetTC5047(IContext context, java.lang.String messageString, java.lang.String searchKey, java.lang.String moreRecord)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		try
		{
			...
			{
				TC5047_ACCSTR01DS msg = new TC5047_ACCSTR01DS(this.getContext());
				
				msg.setKRGACC(msgClass.getMessageNumber(19, 0));
				msg.setKRKNTN(msgClass.getMessageNumber(19, 0));
				msg.setKRPRIO(msgClass.getMessageNumber(2, 0));
				...
				msg.setGNNCLS(msgClass.getMessageNumber(15, 2));
