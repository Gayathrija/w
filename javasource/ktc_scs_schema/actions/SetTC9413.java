...
public class SetTC9413 extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __mxObject;
	private ktc_scs_schema.proxies.TC9413_KORTRG03DS mxObject;

	public SetTC9413(IContext context, IMendixObject mxObject)
	{
		super(context);
	...
	{
		this.mxObject = __mxObject == null ? null : ktc_scs_schema.proxies.TC9413_KORTRG03DS.initialize(getContext(), __mxObject);
