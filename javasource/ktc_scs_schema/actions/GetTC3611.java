...
import ktc_scs_schema.proxies.TC3611_MessageEStatement;
import ktcmdwscsconnector.customs.MessageClass;

public class GetTC3611 extends CustomJavaAction<IMendixObject>
{
	private java.lang.String messageString;

	public GetTC3611(IContext context, java.lang.String messageString)
	{
		super(context);
	...
	public IMendixObject executeAction() throws Exception
	{
		...
		TC3611_MessageEStatement msg = new TC3611_MessageEStatement(this.getContext());
		...
		try
		{
			...
			msg.setWDDTTM(msgClass.getMessageNumber(14, false));
