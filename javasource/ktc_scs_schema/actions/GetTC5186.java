...
import ktc_scs_schema.proxies.TC5186_FINFSLDS;
import ktcmdwscsconnector.customs.MessageClass;
import com.mendix.systemwideinterfaces.core.IMendixObject;

public class GetTC5186 extends CustomJavaAction<IMendixObject>
{
	private java.lang.String messageString;

	public GetTC5186(IContext context, java.lang.String messageString)
	{
		super(context);
	...
	public IMendixObject executeAction() throws Exception
	{
		...
		TC5186_FINFSLDS msg = new TC5186_FINFSLDS(this.getContext());
		...
		try
		{
			...
			msg.setFSPGMN(msgClass.getMessageString(10));
			msg.setFSFILN(msgClass.getMessageString(10));
