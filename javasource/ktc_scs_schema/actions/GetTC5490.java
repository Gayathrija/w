...
import ktc_scs_schema.proxies.TC5490Rs_KNTRSK27DS;
import ktcmdwscsconnector.customs.MessageClass;

public class GetTC5490 extends CustomJavaAction<java.util.List<IMendixObject>>
{
	private java.lang.String messageString;
	private java.lang.String searchKey;
	private java.lang.String moreRecord;

	public GetTC5490(IContext context, java.lang.String messageString, java.lang.String searchKey, java.lang.String moreRecord)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		try
		{
			...
			{
				TC5490Rs_KNTRSK27DS msg = new TC5490Rs_KNTRSK27DS(this.getContext());
				...
				msg.setLLORGA(msgClass.getMessageNumber(15, 2, false));
				msg.setKRSLDO(msgClass.getMessageNumber(15, 2, false));
				msg.setKRPRBO(msgClass.getMessageNumber(15, 2, false));
				msg.setWDABAL(msgClass.getMessageNumber(15, 2, false));
				...
				msg.setLLINNB(msgClass.getMessageNumber(5, 0, false));
