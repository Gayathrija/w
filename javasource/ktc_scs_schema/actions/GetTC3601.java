...
import ktc_scs_schema.proxies.TC3601_KNTRSK23DS_Rs;
import ktcmdwscsconnector.customs.MessageClass;

public class GetTC3601 extends CustomJavaAction<IMendixObject>
{
	private java.lang.String messageString;

	public GetTC3601(IContext context, java.lang.String messageString)
	{
		super(context);
	...
	public IMendixObject executeAction() throws Exception
	{
		...
		TC3601_KNTRSK23DS_Rs msg = new TC3601_KNTRSK23DS_Rs(this.getContext());
		...
		try
		{
			...
			msg.setIPEMLP(msgClass.getMessageString(30));
