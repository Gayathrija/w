...
import ktc_scs_schema.proxies.TC1655_KNTRSK33DS;
import ktcmdwscsconnector.customs.MessageClass;

public class GetTC1655 extends CustomJavaAction<java.util.List<IMendixObject>>
{
	private java.lang.String messageString;
	private java.lang.String searchKey;
	private java.lang.String moreRecord;

	public GetTC1655(IContext context, java.lang.String messageString, java.lang.String searchKey, java.lang.String moreRecord)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		try
		{
			...
			{
				TC1655_KNTRSK33DS msg = new TC1655_KNTRSK33DS(this.getContext());
				...
				msg.setKRSLDO(msgClass.getMessageNumber(15 , false));
				msg.setKRBKRD(msgClass.getMessageNumber(11, false));
				msg.setAPOAMT(msgClass.getMessageNumber(15, false ));
				msg.setAPTMTO(msgClass.getMessageNumber(5, false));
				msg.setAPPAMT(msgClass.getMessageNumber(15, false));
				msg.setKTGTDT(msgClass.getMessageNumber(5, false));
				msg.setKTGTDP(msgClass.getMessageNumber(5, false));
				msg.setKRLBET(msgClass.getMessageNumber(15, false));
				...
				msg.setWDOTB0(msgClass.getMessageNumber(15, false));
