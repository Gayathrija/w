...
import ktc_scs_schema.proxies.TC5088_INBETR04DS;
import ktcmdwscsconnector.customs.MessageClass;

public class GetTC5088 extends CustomJavaAction<java.util.List<IMendixObject>>
{
	private java.lang.String messageString;
	private java.lang.String searchKey;
	private java.lang.String moreRecord;

	public GetTC5088(IContext context, java.lang.String messageString, java.lang.String searchKey, java.lang.String moreRecord)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		try
		{
			...
			{
				TC5088_INBETR04DS msg = new TC5088_INBETR04DS(this.getContext());
				...
				msg.setWDBDAT(msgClass.getMessageNumber(8,0));
