...
import ktc_scs_schema.proxies.TC5003_KORTRG01DS;
import ktcmdwscsconnector.customs.MessageClass;

public class GetTC5003 extends CustomJavaAction<java.util.List<IMendixObject>>
{
	private java.lang.String messageString;
	private java.lang.String searchKey;
	private java.lang.String moreRecord;

	public GetTC5003(IContext context, java.lang.String messageString, java.lang.String searchKey, java.lang.String moreRecord)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		try
		{
			...
			{
				TC5003_KORTRG01DS msg = new TC5003_KORTRG01DS(this.getContext());
				...
				msg.setKTSPKD(msgClass.getMessageString(1));
